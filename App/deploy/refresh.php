...
// reload — every tab (Summary, Registration, Sponsors, T-Shirts, Setup,
// History) re-fetches this on selection (see app.js's refreshShowData()) so
...
//
// Returns exactly what carshow_boot_data() (lib.php) assembles — the same
...
echo json_encode(array_merge(['ok' => true], carshow_boot_data($year)));
